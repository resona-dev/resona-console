...
import type { GetAllJobsError, GetAllJobsResponse, CreateJobData, CreateJobError, CreateJobResponse, UpdateJobData, UpdateJobError, UpdateJobResponse, GetJobData, GetJobError, GetJobResponse, RemoveJobData, RemoveJobError, RemoveJobResponse, GetAllCompletedJobsError, GetAllCompletedJobsResponse, PauseJobData, PauseJobError, PauseJobResponse, ResumeJobData, ResumeJobError, ResumeJobResponse } from './types.gen';
 ...
 * Update Job
 */
export const updateJob = <ThrowOnError extends boolean = false>(options: Options<UpdateJobData, ThrowOnError>) => { return (options?.client ?? client).post<UpdateJobResponse, UpdateJobError, ThrowOnError>({
    ...options,
    url: '/jobs/{job_id}'
}); };
 ...
 */
export const getAllCompletedJobs = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => { return (options?.client ?? client).get<GetAllCompletedJobsResponse, GetAllCompletedJobsError, ThrowOnError>({
    ...options,
    url: '/jobs/completed'
}); };
